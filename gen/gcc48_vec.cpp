// Self-contained gcc 4.8 vec.h — no system headers
// Stubs for C library functions vec.h uses
...
#define STATIC_ASSERT_EXPR(X, MSG) ((void)0)
#define GTY(x)
#define gcc_assert(x)
...
template<typename T> T *ggc_alloc() { return (T*)malloc(sizeof(T)); }
