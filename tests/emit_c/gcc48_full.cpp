...
struct vec {
    ...
    void release() { if (data_) free(data_); data_ = 0; length_ = 0; alloc_ = 0; }
};
...
vec<int> gather_uids(vec<cgraph_node *> nodes) {
    vec<int> result;
    result.data_ = 0; result.length_ = 0; result.alloc_ = 0;
...
int main() {
    ...
    worklist.data_ = 0; worklist.length_ = 0; worklist.alloc_ = 0;
